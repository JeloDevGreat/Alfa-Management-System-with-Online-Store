...
if(isset($_REQUEST['pro'])&&is_array($_REQUEST['pro'])){
...
<div class="panel panel-default sidebar-menu"><!--- panel panel-default sidebar-menu Starts -->
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Starts -->
        ...
        <div class="panel-body scroll-menu"><!-- panel-body scroll-menu Starts -->
            ...
            <ul class="nav nav-pills nav-stacked category-menu list-group" id="dev-p-cats"><!-- nav nav-pills nav-stacked category-menu Starts -->
                ...
                while($row_p_cats = mysqli_fetch_array($run_p_cats)){
                    ...
                    echo "
                        ...
                        <li class='checkbox checkbox-primary list-group-items' style='background:#dddddd;' >
                ...
                while($row_p_cats = mysqli_fetch_array($run_p_cats)){
                    ...
                    <li class='checkbox checkbox-primary list-group-items'>
...
<div class="panel panel-default sidebar-menu"><!--- panel panel-default sidebar-menu Starts -->
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Starts -->
        ...
        <div class="panel-body scroll-menu"><!-- panel-body scroll-menu Starts -->
            ...
            <ul class="nav nav-pills nav-stacked category-menu list-group" id="dev-cats"><!-- nav nav-pills nav-stacked category-menu Starts -->
