<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
						<a href="chekckout.php" class="footer-nav__link">Sign in</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				555 Bugallion St. Estacion, Paniqui, Tarlac 
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">0916 695 0647</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:ajj.alfasportscity@gmail.com" class="email__addr">alfascportscity@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2024 Alfa SportsCity&trade;
			</div>
		</div>
	</div>
</footer>
