...
<body>
  ...
  <header class="page-header fixed-top">
    ...
    <!-- bottomline -->
    <nav class=" navbar dflex ps-3 bg-dark">
      ...
      <ul class="nav list-unstyled align-items-center text-white">
...
<!-- 
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="customer/my_account.php?my_orders">
              My Account
              <i class="icon-down-open-1"></i>
            </a>
