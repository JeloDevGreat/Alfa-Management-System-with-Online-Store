  ...
  <!-- <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> AT ALFA
      </div>
      <p class="nero__text">
      </p>
    </div>
    ...
    <div class="container" ><!-- container Starts -->
      ...
      <div class="col-md-12" ><!-- col-md-12 Starts -->
        ...
        <div class="box" ><!-- box Starts -->
          ...
          <form action="customer_register.php" method="post" enctype="multipart/form-data" style="width:20em" class="mx-auto"><!-- form Starts -->
            ...
            <div class="form-group"><!-- form-group Starts -->
              ...
              <div class="input-group"><!-- input-group Starts -->
                ...
                <span class="input-group-addon"><!-- input-group-addon Starts -->
                  ...
                  <div id="meter_wrapper" class="h-100"><!-- meter_wrapper Starts -->

                    <span id="pass_type"> </span>

                    <div id="meter" class="h-100"> </div>
...
$from = "ajj.alfasportscity@gmail.com";

$message = "

<h2>
Email Confirmation By Alfa SportsCity $c_name
</h2>
